Public Class UpdateSeats
    ...
    'Team: 12SDD05
    'Description: Allows the user to select seats for updated bookings.
                ...
                For i = 0 To 39
                    For p = 0 To 39
                        If (arrClients(i).SeatsBooked IsNot Nothing AndAlso arrClients(i).SeatsBooked.Count > 0) Then
                            If i <> bytRecToBeUpdated Then
                                If arrClients(i).SeatsBooked(p) = CType(c, PictureBox).AccessibleName Then
    ...
    Private Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
        ...
        If MsgBox("Would you like to confirm the client's seats? The payment will be $50.99 multiplied by the number of seats chosen.", MsgBoxStyle.YesNo, "Confirmation") = MsgBoxResult.Yes Then
